Function Identity-AzureAD-Overview-Licenses-1-Start {
    # =========
    # Execution
    # =========
    ...
    Script-Index-Objects -FunctionName ($MyInvocation.MyCommand).Name -Filter * -Type "Office365Licenties" -Functie "Overzicht"
    # ==========
    # Finalizing
    # ==========
